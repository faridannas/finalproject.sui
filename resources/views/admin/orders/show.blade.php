        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900">Rp {{ number_format($order->payment->amount, 0, ',', '.') }}</p>
                                </div>
                    ...
                    <!-- Actions -->
                    <div class="flex justify-between items-center">
                        <a href="{{ route('admin.orders.index') }}" class="text-blue-600 hover:text-blue-500 font-medium">
                            ← Back to Orders
                        </a>
