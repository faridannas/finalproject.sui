                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div class="p-6 sm:p-8 space-y-6">
                                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-4">Informasi Produk</h3>
                                ...
                                <div>
                                    ...
                                    <textarea name="desc" id="desc" rows="6"
                                              ...
                                              placeholder="Jelaskan produk Anda..." required>{{ old('desc', $product->desc) }}</textarea>
                                    @error('desc')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div class="p-6 space-y-4">
                                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-4">Gambar Produk</h3>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="relative aspect-square w-full bg-gray-50 rounded-xl border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden group">
                                        ...
                                        @else
                                            ...
                                            <div id="image-placeholder" class="text-center p-4">
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">Belum ada gambar</p>
                                            </div>
                                        @endif
                                    ...
                                    <p class="text-xs text-center text-gray-500">PNG, JPG, GIF maksimal 2MB</p>
                                    @error('image')
