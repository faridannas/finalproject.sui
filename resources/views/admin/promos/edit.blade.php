    ...
    <div class="py-6 md:py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="p-6 md:p-8">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900">Edit Kode Promo</h3>
                                <p class="text-sm text-gray-600 mt-1">Perbarui detail kode diskon promosi</p>
                            </div>
                        </div>
                    ...
                    <form method="POST" action="{{ route('admin.promos.update', $promo) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                ...
                                Gunakan huruf kapital dan angka. Harus unik.
                            </p>
                            @error('code')
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                ...
                                Anda dapat memperpanjang atau mempertahankan tanggal kadaluarsa saat ini
                            </p>
                            @error('valid_until')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-dashed border-blue-300 rounded-xl p-6">
                            ...
                            <div class="bg-white rounded-lg p-4 shadow-sm">
                                ...
                                <div class="mt-3 pt-3 border-t border-gray-200">
                                    <p class="text-xs text-gray-500">Berlaku hingga: <span class="font-semibold text-gray-700" id="preview-date">{{ $promo->valid_until->format('d F Y') }}</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200">
                            ...
                            <button type="button" 
                                    onclick="if(confirm('Apakah Anda yakin ingin menghapus promo ini? Tindakan ini tidak dapat dibatalkan.')) { document.getElementById('delete-form').submit(); }"
            ...
            <div class="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-6">
                <h4 class="text-sm font-semibold text-gray-700 mb-4">Informasi Promo</h4>
